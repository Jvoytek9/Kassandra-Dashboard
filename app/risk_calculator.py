        ...
        dcc.Tabs(id="tabs", children=[
            dcc.Tab(label='Risk Calculator', children=[
                ...
                html.Div([
                    ...
                    html.Br(),
                    html.Br(),
                    html.P("*The current literature does not provide data for options other than female and male (gender assigned at birth), so there is no data available for intersex. There is also no data available for those who are non-cisgendered."),
                    ...
                    "A high percent positive value can indicate high transmission within the population or that there are more people with COVID-19 that have not been tested yet.",style={"display":"inline","padding-right":"5px"}),
					html.P("This data was taken from the" ,style={"display":"inline","padding-right":"5px"}),
					html.A("CDC", href="https://covid.cdc.gov/covid-data-tracker/#cases_casesper100klast7days"),
					html.A(", the accuracy is dependent on the each states' individual reporting.",style={"display":"inline"}),
                    ...
                    html.Br(),
                    html.Br(),
                    html.H4("Gender Mortality Risk: ",style={"display":"inline-block"}),
                    ...
                    html.A("“Gender differential in COVID-19 mortality varies markedly by age”",href="https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(20)31748-7/fulltext",style={"display":"inline"}),
                    html.P(", men were found to have a 2x higher mortality rate which may be attributed to “lifestyle to differences in chromosomal structure”. They also found differences in mortality rates when looking at gender by age group.”",style={"display":"inline"}),
                    html.Br(),
...
def register_risk_callbacks(app):
    ...
    def risk_analysis(gender,race,age,state,county,med,takeout,walk,lib,eatOut,walkTown,BBQ,beach,mall,grandpa,pool,barber,eatIn,plane,buffet,gym,bar):
        ...
        sex_data = master.loc[master['sex'] == gender]
        if sex_data.empty:
